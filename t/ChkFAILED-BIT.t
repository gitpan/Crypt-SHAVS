...
# Make sure Crypt::SHAVS reports "FAILED" on corrupted 3rd vector
...
$fh->seek(0, 0);
while (<$fh>) {
	if ($testnum == 3) { print "not " unless /FAILED\s*$/ }
	else               { print "not " unless /OK\s*$/ }
	print "ok ", $testnum++, "\n";
}
close($fh);
...
MD =   0aadec36139d9e80073bd815c4464b6e9375bbf5
